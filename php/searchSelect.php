...
//$sqlStr = "select * from `goodslist` where goodsName like '%$word%' or goodsMsg like '%$searchVal%' or goodsPrice like '%$searchVal%' ORDER BY goodsPrice";

    $sqlStr = "select * from `show` where showname like '%$word%' or showcity like '%$word%' or shower like '%$word%' or pricebetween like '%$word%' or showtime like '%$word%' ORDER BY $sortBy";
